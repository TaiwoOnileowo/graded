// app/api/execute/route.ts (for App Router)
// If using Pages Router, put this at pages/api/execute.ts instead
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Validate language
    const supportedLanguages: string[] = ['c', 'cpp', 'python', 'javascript', 'java'];
    ...
    // Execute the code
    const result = await executeCode(filePath, language.toLowerCase(), submissionPath);
...
// If you need to handle OPTIONS requests for CORS (App Router)
